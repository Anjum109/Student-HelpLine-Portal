...
<?php
$selectquery ="select * from admininfo where Useremail='$_SESSION[Useremail]'" ;
...
$pic=$_FILES['file']['name'];
    ...
    $query ="UPDATE admininfo SET pic='$pic', FirstName ='$FirstName', LastName='$LastName', Useremail ='$Useremail', Gender ='$Gender',BloodGroup='$BloodGroup' where Useremail='$_SESSION[Useremail]'; ";
