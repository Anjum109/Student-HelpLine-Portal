...
if (isset($_POST["submit"])) {
  ...
  $check_email = mysqli_query($dbc, "SELECT * FROM admininfo WHERE Useremail='$Useremail'");

  if (mysqli_num_rows($check_email) > 0) {
      $data = mysqli_fetch_assoc($check_email);
      
      $to = $Useremail;
      $subject = "Change Password - Student HelpLine Portal";
      ...
      <p><a href='{$base_url}confirm_admin_change_pass.php?token={$data['token']}'>Reset Password</a></p>
      </body>
      </html>
      ";
      ...
      if (mail($to,$subject,$message,$headers)) {
        echo "<script>alert('We have sent a password link to your email - {$Useremail}.');</script>";
      } else {
        ...
        <div class="box">
              ...
              <br>
                ...
                <i class="fa fa-envelope" id="Useremail"></i>
                    ...
                    <br><br>
                     <button type="submit" name="submit">Send Change Password Link</button>
                </form>
