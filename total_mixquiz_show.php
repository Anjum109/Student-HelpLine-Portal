...
<?php 
    ...
    <?php
            ...
            <td>
                                   <a href="add_mix_quiz.php?id=<?php echo $data['id']; ?>">  <i data-toggle="tooltip" data-placement="bottom" title="ADD" class="fas fa-edit" ></i></a></span>
                                
                                </td>
                                <td>
                                    <span class="remove"> <a href="delete_mix_quiz_question.php?id=<?php echo $data['id']; ?>" class="delete"><i data-toggle="tooltip" data-placement="bottom" title="Delete" class="fas fa-trash" aria-hidden="true"></i></a></span>
                                </td>
