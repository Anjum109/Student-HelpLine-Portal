		...
		<div class="arrival-wrapper">
			...
			<a href="add-book.php" class=" box">
				...
				<i class="fas fa-book"></i>
					...
					<h4 style="font-size: 17px; margin-left:40px; padding:5px;"> Book Add</h4>
...
<div class=" arrival">
	...
	<?php 
		...
		<div class="arrival-wrapper">
			...
			<a href="total_book.php" class=" box">
				<div class="image">
				</div>
				...
				<i class="fas fa-book"></i>
					<?php echo '<p > '.$data.'</p>';?>
					<h4 style="font-size: 18px; margin-left:55px; padding:2px;"> Total Book</h4>
