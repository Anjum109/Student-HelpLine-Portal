...
error_reporting(0);
  ...
  if (isset($_POST["submit"])) {
    ...
    $check_email = mysqli_num_rows(mysqli_query($dbc, "SELECT Useremail FROM userinfo WHERE Useremail='$Useremail'"));
    $base_url=  "http://localhost/project4/";
...
window.location = "signup.php"; 
    ...
    <?php
      ...
      $sql = "INSERT INTO userinfo (FirstName,LastName,Useremail,profession, Gender,BloodGroup, password,token,status, pic,time)
      VALUES ('$FirstName', '$LastName', '$Useremail','$profession','$Gender','$BloodGroup ','$password','$token','0','p.png','$time')";
