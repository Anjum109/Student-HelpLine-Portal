    ...
    if(isset($_POST["verify"])){
        ...
        if($otp != $otp_code){
           ...
           <?php
            ...
            mysqli_query($dbc, "UPDATE admininfo SET status1 = '1' WHERE Useremail = '$Useremail'");
            ?>
             <script>
                 alert("Verfiy account done,please wait few min you may sign in after admin approval ");
