...
$q ="UPDATE html_quiz  SET que ='$que', option1='$option1', option2 ='$option2',option3 ='$option3', option4 ='$option4',ans='$ans' where id=$ids ";
	
	$r=mysqli_query($dbc,$q);
    if ($r) {
       
        echo "<script>alert('added.')</script>";
        header("location: total_htmlquiz_show.php ");
    }
