...
$cat_name= $dbc->real_escape_string($_POST["cat_name"]);
	...
	$q="INSERT INTO quiz (que,option1,option2,option3,option4,ans,userans,cat_name) VALUES ('$que','$option1','$option2','$option3','$option4','$ans','','$cat_name')";
  ...
  <div style="margin-top: 20px; text-align:center; margin-left:250px; ">   
        ...
        <div class="col-sm-9 col-sm-offset-3 col-md-10 col-md-offset-2 main">
		  ...
		  <div class="form-group">
              <label for="exampleFormControlSelect1">SELECT QUIZ SET </label>
              <select class="form-control" id="exampleFormControlSelect1"  name="cat_name">

		
                <option  class="active">Choose Set</option>
                <?php 
