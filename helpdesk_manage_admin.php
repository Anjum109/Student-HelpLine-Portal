			...
			<div class="head-title">
				<div class="left">
					...
					<ul class="breadcrumb">
						...
						<li>
							<a class="active" href="#">Q & A Management</a>
						</li>
					</ul>
				</div>
...
<div class=" arrival">
	...
	<?php 
		...
		<div class="arrival-wrapper">
			...
			<a href="total_question.php" class=" box">
				<div class="image">
				</div>
				...
				<i class="fas fa-user-alt"></i>
					<?php echo '<p > '.$data.'</p>';?>
					<h4 style="font-size: 18px; margin-left:25px; padding:2px;"> Total Question</h4>
...
<div class=" arrival">
	...
	<?php 
		...
		<div class="arrival-wrapper">
			...
			<a href="total_answer.php" class=" box">
				<div class="image">
				</div>
				...
				<i class="fas fa-user-alt"></i>
					<?php echo '<p > '.$data.'</p>';?>
					<h4 style="font-size: 18px; margin-left:33px; padding:2px;"> Total Answer</h4>
