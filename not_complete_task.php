...
<div class="main-section">
      ...
      $uid=$_SESSION['USER_ID'];
          $todos = $dbc->query("SELECT * FROM task_manager where user_id='$uid' AND task='not complete'");
       ?>
       ...
       <?php if (mysqli_num_rows( $todos) <= 0){ ?>
                ...
                <?php } ?><br>
                <a class="cmt"href="task_manager.php" style="margin-left:200px;"><b>All Task</b></a>&nbsp;&nbsp;&nbsp;&nbsp;
                <a class="cmt"href="complete_task.php" ><b>Completed Task</b></a>&nbsp;&nbsp;&nbsp;&nbsp;
<a class="cmt" href="not_complete_task.php"id="acmt"><b>Not Completed Task</b></a>
                <br><br><br>
