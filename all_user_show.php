...
<div class="heading">
    ...
    <span class="s">O</span>
            ...
            <td>
                                    <span class="remove"> <a href="delete_user.php?id=<?php echo $data['id']; ?>" class="delete"><i data-toggle="tooltip" data-placement="bottom" title="Delete" class="fas fa-trash" aria-hidden="true"></i></a></span>
                                </td>
